...
public class VadationCodeBeanV2 {
	 ...
	 *            图片高
	 */
	public VadationCodeBeanV2(int width, int height) {
		this.width = width;
		this.height = height;
		this.createCode();
	}
	 ...
	 *            干扰线条数
	 */
	public VadationCodeBeanV2(int width, int height, int codeCount, int lineCount) {
		this.width = width;
		this.height = height;
	...
	private String getFontByteStr() {
		...
		System.out.println(this.getClass().getResource("").toString());*/
		InputStream is = this.getClass().getResourceAsStream("well.font");
		String result = null;
		try {
	...
	public static void main(String[] args) {
		VadationCodeBeanV2 bean = new VadationCodeBeanV2();
		try {
			bean.write("C:\\Users\\ruibo\\Desktop\\abc.jpg");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
